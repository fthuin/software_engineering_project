...
urlpatterns = patterns('tennis.views',
                       ...
                       url(r'^resultat$', 'allResult'),
                       url(r'^resultats/(\d+)$', 'resultat'),
                       ...
                       url(r'^tournoi/score/poule(\d+)$', 'enterScore'),
                       ...
                       url(r'^staff/tournois/poules/printScoreBoard/(\d+)$',
                           'printScoreBoard'),
                       url(r'^staff/tournois/poules/([\w ]+)$',
                           'pouleTournoi'),
                       url(r'^staff/tournois/poules/scores/(\d+)$', 'pouleScore'),
                       url(r'^staff/tournois/poules/scores/resultat/(\d+)$',
                           'pouleViewScore'),
                       url(r'^staff/tournois/knockoff/([\w ]+)$', 'knockOff'),
                       url(r'^staff/tournois/knockoffprint/([\w ]+)$', 'knockoff_print'),
                       ...
                       url(r'^staff/inscriptions$', 'staffExtra'),
