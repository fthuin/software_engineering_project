...
def send_confirmation_email_pair_registered(): 
    #Init Mail variable
    playerOnePrenom = ""
    playerOneFullName = ""
    playerOneAdresseMail = "pokcyril@hotmail.com"

    playerTwoPrenom = ""
    playerTwoFullName = ""
    playerTwoAdresseMail = "pokcyril@hotmail.com"
...
def send_confirmation_email_court_registered():
    #Init Mail variable
    prenom = ""
	typeCourt = ""
	adresseCourt = ""
	disponibleSamedi = False
	disponibleDimanche = False
	...
	if disponibleDimanche && disponibleSamedi:
