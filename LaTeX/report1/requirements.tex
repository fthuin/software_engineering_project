...
\begin{enumerate}
    ...
    \item Players receive the printed knock-off table, the addresses of
        the courts, and the contact information of the opponents
    ...
    \item Winners and finalists of each tournament are displayed on a
        specific web page at the end of the day
...
\begin{enumerate}
    ...
    \item Players can submit match results via their smart-phone
