...
choose which framework to use, in order to respect this architecture and ease the
...
the website, and motivate our choice of those specific frameworks. \newline

Of course, all frameworks that we have considered can be used to implement
...
on using \textbf{Django}, an open-source framework, for the back-end aspect. It
...
The main advantage of this framework being its architecture which is
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{minipage}{0.45\linewidth}
                \item The URL dispatcher (urls.py) maps the requested URL
                    ...
                    in Django. You can cache more granularity, as well.
