...
progression of the project. We think we can implement the main part of
the project in a month (for the second iteration) and the elective part
for the 3rd iteration, but if the first iteration don't go well we may
change this planning. Here are the dates where everyone is
