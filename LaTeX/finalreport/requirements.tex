...
We chose to work with accounts instead of the old registration process because
...
Once the pair is selected, the user can choose between several extra services,
