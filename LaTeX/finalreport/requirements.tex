...
\todo[inline]{Alexandre: ce n'est pas correct, les utilisateurs ne peuvent pas soumettre des scores via le site web. (ou bien je n'ai pas trouvé où c'était sur le site...)}

\textcolor{red}{Once the groups have been created, and the first matches have finished, 
